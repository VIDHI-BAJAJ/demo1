    ...
    [313],
    {
        ...
        4992: (e, t) => {
            ...
            t.default = class DropdownMenuHeightController {
                ...
                calculateStickyMenuNavHeight() {
                    ...
                    const e =
                        this.widgetConfig.elements.$dropdownMenuContainer.offset()
                ...
                isElementSticky() {
                    return (
                        ...
                        this.widgetConfig.elements.$element.parents(
                            ".elementor-sticky"
                        ).length
                    );
                }
                getMenuHeight() {
                    return this.isElementSticky()
                        ...
                        : this.widgetConfig.settings
                              .dropdownMenuContainerMaxHeight;
                }
                setMenuHeight(e) {
                    this.widgetConfig.elements.$dropdownMenuContainer.css(
                        this.widgetConfig.settings.menuHeightCssVarName,
                ...
                reassignMenuHeight(e) {
                    ...
                    e.height() > t &&
                        (e.css(
                            "height",
                            this.calculateMenuTabContentHeight(e) + "px"
                        ),
                ...
                isToggleActive() {
                    ...
                    return this.widgetConfig.attributes?.menuToggleState
                        ? "true" ===
                              e.attr(
                                  this.widgetConfig.attributes.menuToggleState
                              )
                        : e.hasClass(
        ...
        820: (e, t, n) => {
            ...
            class _default extends elementorModules.frontend.handlers.Base {
                ...
                getDefaultSettings() {
                    return {
                        selectors: { container: ".elementor-widget-container" },
                    };
                }
                getDefaultElements() {
                    ...
                    return (
                        0 === t.length && (t = this.$element), { $container: t }
                    );
                }
                bindEvents() {
                ...
                toggle() {
                    ...
                    ["motion_fx", "background_motion_fx"].forEach((n) => {
                        ...
                        (!s || -1 !== s.indexOf(e)) &&
                        (t[n + "_motion_fx_scrolling"] ||
                            t[n + "_motion_fx_mouse"])
                            ? this[n]
        ...
        3039: (e, t) => {
            ...
            class _default extends elementorModules.Module {
                ...
                scale(e, t) {
                    const n = this.getDirectionMovePoint(
                        t,
                        e.direction,
                        e.range
                    );
                ...
                setCSSTransformVariables(e) {
                    (this.CSSTransformVariables = []),
                        jQuery.each(e, (e, t) => {
                            ...
                            if (n && t) {
                                if ("perspective" === n[1])
                                    return void this.CSSTransformVariables.unshift(
                                        n[1]
                                    );
                ...
                blur(e, t) {
                    const n = this.getDirectionMovePoint(
                        ...
                        s =
                            e.level -
                            this.getEffectValueFromMovePoint(e.level, n);
                ...
                runAction(e, t, n) {
                    t.affectedRange &&
                        (t.affectedRange.start > n &&
                            (n = t.affectedRange.start),
        ...
        739: (e, t, n) => {
            ...
            class _default extends elementorModules.ViewModule {
                ...
                defineDimensions() {
                    const e =
                            this.getSettings("$dimensionsElement") ||
                            this.$element,
                        t = e.offset(),
                        n = {
                ...
                runInteractions() {
                    ...
                    this.actions.setCSSTransformVariables(t.elementSettings),
                        ...
                        jQuery.each(t.interactions, (t, n) => {
                            (this.interactions[t] = new this.interactionsTypes[
                                t
                            ]({
                                motionFX: this,
                                callback: function () {
                ...
                constructor() {
                    super(),
                        ...
                        elementorFrontend.elementsHandler.attachHandler(
                            "stripe-button",
                            () =>
                                Promise.all([n.e(234), n.e(857)]).then(
                                    n.bind(n, 9036)
                                )
                        );
                }
